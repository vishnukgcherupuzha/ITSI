    ...
    <section ref={sectionRef} className="relative py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className={`max-w-3xl mx-auto text-center mb-16 space-y-6 transition-all duration-1000 ${
          ...
          Offload crucial tasks to our experienced professionals. 
          </h2>
          
          <p className="text-lg text-gray-600 leading-relaxed">
          Our end-to-end account management approach ensures that you receive comprehensive support throughout the entire customer lifecycle.
          </p>
        </div>
