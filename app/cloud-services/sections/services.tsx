...
const services = [
  {
    ...
    title: "Tailored Cloud Phone Services Integration",
    description: "We work collaboratively with your team to integrate your specialized cloud phone services seamlessly into your client environments."
  },
  {
    icon: (
      <svg className="w-12 h-12 stroke-primary" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    description: "Enhance your brand with our white-label expertise. Streamline projects for faster time-to-revenue and a seamless customer experience."
  },
  {
    icon: (
      <svg className="w-12 h-12 stroke-primary" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    description: "As your trusted partner, we provide exceptional support to you and your clients, ensuring reliable communications."
  },
  {
    icon: (
      <svg className="w-12 h-12 stroke-primary" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    description: "We understand your business evolves. Our scalable cloud support ensures quality as you grow your customer base."
  },
  {
    icon: (
      <svg className="w-12 h-12 stroke-primary" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    title: "Expert Training and Resources",
    description: "We empower and delight your clients with the necessary training and resources to leverage your cloud phone services effectively."
  },
  // {
  //   icon: (
  //     <svg className="w-12 h-12 stroke-primary" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}>
