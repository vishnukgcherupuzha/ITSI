      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className={`max-w-3xl mx-auto text-center mb-16 space-y-6 transition-all duration-1000 ${
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            From initial planning to seamless implementation, our seasoned consultants ensure optimal solutions that boost productivity. Leverage our industry best practices, extensive experience, and certified team to drive measurable results and fuel your growth.
          </p>
        </div>
